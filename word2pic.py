...
def word2pic(txt_path='./source.txt', ttf_path="./src/writeup.TTF", save_path="./result/", size=4, white=False, fill=(0, 0, 0, 255)):
        ...
        for i in range(28):
            ...
            while j < 995 :
                ...
                if string[flag] == '\n':
                    flag += 1
                    break
                draw.text((random.random() * size / 2 + j, 83 + random.random() * size + i * 48), string[flag], fill, font=font)
